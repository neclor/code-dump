...
*
* ARGUMENT
* comparison_fn_t      A key comparison function
*
* RETURN
...
/* ------------------------------------------------------------------------- *
* Returns the number of elements/nodes stored in the given BST.
*
* PARAMETERS
* bst          A valid pointer to a BST object
*
...
/* ------------------------------------------------------------------------- *
* Returns the tree height (the length of the longest path from a root to a
* leaf).
*
* PARAMETERS
* bst          A valid pointer to a BST object
...
/* ------------------------------------------------------------------------- *
* Create an minimal depth BST from a list of key-value pairs. This
* implementation of the BST allows duplicate keys.
*
* PARAMETERS
* key          The key of the new element
...
*
* RETURN
* ll           A List containing the element in the given range, or
