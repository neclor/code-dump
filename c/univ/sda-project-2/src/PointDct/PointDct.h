...
/* ------------------------------------------------------------------------- *
 * Returns the average node depth. This function is meant only for debugging.
 * It should be called only when the dictionary is implemented using a tree
 * structure and after having called pdctCreate.
 *
 * PARAMETERS
 * pd           A valid pointer to a PointDct object
 *
 * RETURN
 * d            The average depth of a node in the tree.
 *
 * ------------------------------------------------------------------------- */
size_t pdctAverageNodeDepth(PointDct *pd);

/* ------------------------------------------------------------------------- *
 * Returns the height of the tree. This function is meant only for debugging.
 * It should be called only when the dictionary is implemented using a tree
 * structure and after having called pdctCreate.
 *
 * PARAMETERS
